...
namespace z_dht::bencode {
    ...
    public:
         ...
         */
        explicit Value(const std::variant<Integer, String, List, Dict> &input);
         ...
         */
        std::variant<Integer, String, List, Dict> data() const {
            return data_;
        }

    private:
        std::variant<Integer, String, List, Dict> data_;
